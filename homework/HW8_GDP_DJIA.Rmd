...
```{r}
GDPd <- read_csv("https://raw.githubusercontent.com/dwillis/jour405/refs/heads/main/data/gdp_djia.csv")
```
...
It has a pretty strong correlation yeah. The correlation calculation was over 0.9 and the line on the scatterplot shows an almost perfect 45 degree angle.
